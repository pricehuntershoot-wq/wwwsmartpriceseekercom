  ...
  for (const product of products) {
    try {
      ...
      const shopName = product.eshop === 'alza' ? 'Alza.cz' : 
                        ...
                        product.eshop === 'xiaomi' ? 'Xiaomi Store' : product.eshop;
...
Given search results from multiple e-shops (Alza.cz, CZC.cz, Datart.cz, Smarty.cz, Mironet.cz, MP.cz, Refurbed.cz, Amazon.de, Xiaomi Store), extract products from EVERY e-shop section.
...
6. For URLs: Alza prepend "https://www.alza.cz", CZC "https://www.czc.cz", Datart "https://www.datart.cz", Smarty "https://www.smarty.cz", Mironet "https://www.mironet.cz", MP "https://www.mp.cz", Refurbed "https://www.refurbed.cz", Amazon "https://www.amazon.de", Xiaomi "https://www.mi-store.cz" if path starts with "/".
            ...
            products: {
              ...
              items: {
                ...
                properties: {
                  ...
                  eshop: { type: "string", enum: ["alza", "czc", "datart", "smarty", "mironet", "mp", "refurbed", "amazon", "xiaomi"] },
